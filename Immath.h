...
inline float IntersectRayPlane(const vec4& rOrigin, const vec4& rVector, const vec4& plan)
{
...
inline float MinimumDistance(vec3 v, vec3 w, vec3 p, vec3& projection)
{
